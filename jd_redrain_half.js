...
[task_local]
#半点京豆雨
30 20-23/1 * * * jd_live_redrain.js, tag=半点京豆雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "30 20-23/1 * * *" script-path=jd_live_redrain.js,tag=半点京豆雨
================Surge===============
半点京豆雨 = type=cron,cronexp="30 20-23/1 * * *",wake-system=1,timeout=3600,script-path=jd_live_redrain.js
===============小火箭==========
半点京豆雨 = type=cron,script-path=jd_live_redrain.js, cronexpr="30 20-23/1 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点京豆雨');
let allMessage = '', id = '';
