...
==============Loon==============
[Script]
cron "30 20-23/1 * * *" script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_live_redrain.js,tag=半点京豆雨
================Surge===============
半点京豆雨 = type=cron,cronexp="30 20-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_live_redrain.js
===============小火箭==========
半点京豆雨 = type=cron,script-path=https://raw.githubusercontent.com/msechen/jdrain/main/jd_live_redrain.js, cronexpr="30 20-23/1 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点京豆雨');
let allMessage = '', id = '';
